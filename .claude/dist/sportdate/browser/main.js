...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-XEGJ2HL4.js").then((m) => m);
...
// src/app/constants/app-routing.constants.ts
var APP_ROUTES = {
  DASHBOARD: "dashboard",
  MATCH: "match",
  EVENTOS: "eventos",
...
var routes = [
  { path: "", redirectTo: APP_ROUTES.DASHBOARD, pathMatch: "full" },
  {
    ...
    loadComponent: () => import("./chunk-QPDXKWOF.js").then((m) => m.DashboardComponent)
  },
  {
    path: APP_ROUTES.MATCH,
    loadComponent: () => import("./chunk-GHUQ7U4D.js").then((m) => m.MatchComponent)
  },
  {
    path: APP_ROUTES.EVENTOS,
    loadComponent: () => import("./chunk-GKHFLHDY.js").then((m) => m.EventosComponent)
  },
  {
    path: APP_ROUTES.RANKING,
    loadComponent: () => import("./chunk-ZISVZCNH.js").then((m) => m.RankingComponent)
  },
  {
    path: APP_ROUTES.GRUPOS,
    loadComponent: () => import("./chunk-NYCKZK76.js").then((m) => m.GruposComponent)
  },
  {
    path: APP_ROUTES.CHAT,
    loadComponent: () => import("./chunk-3H6WRWQC.js").then((m) => m.ChatComponent)
  },
  {
    path: APP_ROUTES.PERFIL,
    loadComponent: () => import("./chunk-3B5NC5F7.js").then((m) => m.PerfilComponent)
  },
  { path: "**", redirectTo: APP_ROUTES.DASHBOARD }
];

// src/app/store/state.ts
var STATES = [UserState, EventsState, CommunitiesState, LeaderboardState];
...
// src/app/core/repositories/in-memory/mock-data.ts
var MOCK_PROFILES = [
  {
    id: "1",
    name: "Camila",
  ...
  },
  {
    ...
    sports: [
      ...
      { name: "F\xFAtbol", color: "bg-teal-100 text-teal-600" }
    ],
    level: "Nivel 15",
    compatibility: 92,
  ...
  },
  {
    ...
    level: "Nivel 8",
    compatibility: 75,
    bio: "Reci\xE9n empezando con yoga, busco grupo amigable para clases los s\xE1bados.",
    location: "\xD1u\xF1oa"
  }
];
var MOCK_USER_STATS = {
...
var MOCK_EVENTS = [
  ...
  },
  {
    ...
    date: "Mar 18 Mar",
    time: "19:00",
    location: "Parque In\xE9s de Su\xE1rez",
    participants: 15,
    maxParticipants: 20,
...
var MOCK_CHALLENGES = [
  ...
  {
    id: "c4",
    title: "Primer partido de f\xFAtbol",
    description: "Completa un partido de f\xFAtbol 5.",
    sportEmoji: "\u26BD",
    xpReward: 800,
    progress: 0,
    total: 1,
...
var MOCK_GROUPS = [
  {
    ...
    sportEmoji: "\u{1F3C3}",
    members: 142,
    activityLevel: "Muy activo \u{1F525}",
    imageGradient: "from-orange-100 to-orange-200"
  },
  {
    id: "g2",
    name: "F\xFAtbol 5 Provi",
    sportEmoji: "\u26BD",
    members: 48,
  ...
  },
  {
    id: "g4",
    name: "Trekking Chile",
    sportEmoji: "\u{1F3D4}\uFE0F",
    members: 320,
    activityLevel: "Nuevo \u{1F331}",
    imageGradient: "from-green-100 to-green-200"
  }
];
var MOCK_COMMUNITIES = [
  { id: "c1", name: "Runners Santiago", emoji: "\u{1F3C3}", gradient: "from-orange-400 to-rose-400", members: 142, events: 3, messages: 12, tags: ["Running", "Vitacura"], level: "Muy activo \u{1F525}" },
  { id: "c2", name: "F\xFAtbol 5 Provi", emoji: "\u26BD", gradient: "from-teal-400 to-emerald-400", members: 48, events: 2, messages: 8, tags: ["F\xFAtbol", "Providencia"], level: "Activo \u26A1" },
  { id: "c3", name: "Yoga \xD1u\xF1oa", emoji: "\u{1F9D8}", gradient: "from-purple-400 to-pink-400", members: 85, events: 5, messages: 24, tags: ["Yoga", "\xD1u\xF1oa"], level: "Muy activo \u{1F525}" },
  { id: "c4", name: "Trekking Chile", emoji: "\u{1F3D4}\uFE0F", gradient: "from-green-400 to-teal-400", members: 320, events: 1, messages: 5, tags: ["Trekking", "Nacional"], level: "Activo \u26A1" },
  { id: "c5", name: "Padel Masters", emoji: "\u{1F3BE}", gradient: "from-blue-400 to-cyan-400", members: 67, events: 4, messages: 18, tags: ["Padel", "Las Condes"], level: "Muy activo \u{1F525}" },
  { id: "c6", name: "CrossFit Warriors", emoji: "\u{1F3CB}\uFE0F", gradient: "from-red-400 to-orange-400", members: 93, events: 6, messages: 31, tags: ["CrossFit", "Santiago Centro"], level: "Muy activo \u{1F525}" }
];
var MOCK_LEADERBOARD = [
  { rank: 1, id: "u1", name: "Sof\xEDa M.", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Sofia", sport: "Running", xp: 15400, level: 42, trend: "same" },
  { rank: 2, id: "u2", name: "Javier R.", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Javier", sport: "F\xFAtbol", xp: 14200, level: 38, trend: "up" },
  ...
  { rank: 5, id: "me", name: "T\xFA", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Felix", sport: "Multideporte", xp: 2450, level: 12, trend: "up" },
  { rank: 6, id: "u5", name: "Luc\xEDa F.", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Lucia", sport: "Yoga", xp: 2100, level: 10, trend: "down" },
  ...
  { rank: 8, id: "u7", name: "Mar\xEDa J.", avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Maria", sport: "Nataci\xF3n", xp: 1500, level: 8, trend: "up" }
];
var MOCK_TEAMS = [
  { id: "t1", name: "Los Halcones", sport: "\u26BD F\xFAtbol", wins: 12, losses: 3, draws: 2, points: 38, members: 11, avatar: "from-red-500 to-orange-500" },
  { id: "t2", name: "Padel Kings", sport: "\u{1F3BE} Padel", wins: 8, losses: 2, draws: 0, points: 24, members: 4, avatar: "from-blue-500 to-cyan-500" },
  { id: "t3", name: "Sprint Club", sport: "\u{1F3C3} Running", wins: 15, losses: 5, draws: 0, points: 45, members: 8, avatar: "from-green-500 to-teal-500" },
  { id: "t4", name: "Yoga Flow", sport: "\u{1F9D8} Yoga", wins: 10, losses: 1, draws: 0, points: 30, members: 6, avatar: "from-purple-500 to-pink-500" }
];
var MOCK_CHAMPIONSHIPS = [
  { id: "ch1", name: "Liga F\xFAtbol 5 Santiago", sport: "\u26BD", status: "En curso", round: "Semifinal", teams: 8, startDate: "Mar 2024", prize: "500 XP + Trofeo", color: "bg-emerald-500" },
  { id: "ch2", name: "Torneo Padel Primavera", sport: "\u{1F3BE}", status: "Inscripciones", round: "Fase de grupos", teams: 16, startDate: "Abr 2024", prize: "1000 XP + Medalla", color: "bg-blue-500" },
  { id: "ch3", name: "Marat\xF3n Running Challenge", sport: "\u{1F3C3}", status: "Finalizado", round: "Final", teams: 32, startDate: "Feb 2024", prize: "800 XP", color: "bg-orange-500" }
];

// src/app/core/repositories/in-memory/in-memory-user.repository.ts
var InMemoryUserRepository = class _InMemoryUserRepository extends UserRepository {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275InMemoryUserRepository_BaseFactory;
    return function InMemoryUserRepository_Factory(__ngFactoryType__) {
      return (\u0275InMemoryUserRepository_BaseFactory || (\u0275InMemoryUserRepository_BaseFactory = \u0275\u0275getInheritedFactory(_InMemoryUserRepository)))(__ngFactoryType__ || _InMemoryUserRepository);
    };
  })();
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _InMemoryUserRepository, factory: _InMemoryUserRepository.\u0275fac });
};
(() => {
...
// src/app/core/repositories/in-memory/in-memory-event.repository.ts
var InMemoryEventRepository = class _InMemoryEventRepository extends EventRepository {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275InMemoryEventRepository_BaseFactory;
    return function InMemoryEventRepository_Factory(__ngFactoryType__) {
      return (\u0275InMemoryEventRepository_BaseFactory || (\u0275InMemoryEventRepository_BaseFactory = \u0275\u0275getInheritedFactory(_InMemoryEventRepository)))(__ngFactoryType__ || _InMemoryEventRepository);
    };
  })();
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _InMemoryEventRepository, factory: _InMemoryEventRepository.\u0275fac });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InMemoryEventRepository, [{
    type: Injectable
  }], null, null);
})();

// src/app/core/repositories/in-memory/in-memory-community.repository.ts
var InMemoryCommunityRepository = class _InMemoryCommunityRepository extends CommunityRepository {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275InMemoryCommunityRepository_BaseFactory;
    return function InMemoryCommunityRepository_Factory(__ngFactoryType__) {
      return (\u0275InMemoryCommunityRepository_BaseFactory || (\u0275InMemoryCommunityRepository_BaseFactory = \u0275\u0275getInheritedFactory(_InMemoryCommunityRepository)))(__ngFactoryType__ || _InMemoryCommunityRepository);
    };
  })();
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _InMemoryCommunityRepository, factory: _InMemoryCommunityRepository.\u0275fac });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InMemoryCommunityRepository, [{
    type: Injectable
  }], null, null);
})();

// src/app/core/repositories/in-memory/in-memory-leaderboard.repository.ts
var InMemoryLeaderboardRepository = class _InMemoryLeaderboardRepository extends LeaderboardRepository {
  ...
  static \u0275fac = /* @__PURE__ */ (() => {
    let \u0275InMemoryLeaderboardRepository_BaseFactory;
    return function InMemoryLeaderboardRepository_Factory(__ngFactoryType__) {
      return (\u0275InMemoryLeaderboardRepository_BaseFactory || (\u0275InMemoryLeaderboardRepository_BaseFactory = \u0275\u0275getInheritedFactory(_InMemoryLeaderboardRepository)))(__ngFactoryType__ || _InMemoryLeaderboardRepository);
    };
  })();
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _InMemoryLeaderboardRepository, factory: _InMemoryLeaderboardRepository.\u0275fac });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(InMemoryLeaderboardRepository, [{
    type: Injectable
  }], null, null);
})();
...
// src/app/shared/ui/xp-progress-bar/xp-progress-bar.component.ts
function XpProgressBarComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275domElementStart(0, "div", 1)(1, "span", 3);
    \u0275\u0275text(2);
    \u0275\u0275domElementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" Nivel ", ctx_r0.level(), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", ctx_r0.currentXP(), " / ", ctx_r0.maxXP(), " XP ");
  }
}
var XpProgressBarComponent = class _XpProgressBarComponent {
  /** Current XP amount. */
  currentXP = input.required(...ngDevMode ? [{ debugName: "currentXP" }] : []);
  /** XP required for the next level. */
  maxXP = input.required(...ngDevMode ? [{ debugName: "maxXP" }] : []);
  ...
  percentage = computed(() => Math.min(100, this.currentXP() / this.maxXP() * 100), ...ngDevMode ? [{ debugName: "percentage" }] : []);
  ...
  }, ...ngDevMode ? [{ debugName: "heightClass" }] : []);
  static \u0275fac = function XpProgressBarComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _XpProgressBarComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _XpProgressBarComponent, selectors: [["app-xp-progress-bar"]], inputs: { currentXP: [1, "currentXP"], maxXP: [1, "maxXP"], level: [1, "level"], size: [1, "size"], showLabel: [1, "showLabel"] }, decls: 4, vars: 5, consts: [[1, "w-full"], [1, "flex", "justify-between", "items-center", "mb-1"], [1, "h-full", "bg-gradient-to-r", "from-orange-400", "to-rose-500", "rounded-full", "transition-all", "duration-1000", "ease-out"], [1, "text-xs", "font-bold", "text-gray-700", "dark:text-gray-300", "transition-colors"], [1, "text-xs", "font-semibold", "text-gray-500", "dark:text-gray-400", "transition-colors"]], template: function XpProgressBarComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domElementStart(0, "div", 0);
      \u0275\u0275conditionalCreate(1, XpProgressBarComponent_Conditional_1_Template, 5, 3, "div", 1);
    ...
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.showLabel() ? 1 : -1);
      \u0275\u0275advance();
      \u0275\u0275classMap("w-full bg-gray-100 dark:bg-[#2D2D4A] rounded-full overflow-hidden transition-colors " + ctx.heightClass());
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(XpProgressBarComponent, [{
    type: Component,
    args: [{ selector: "app-xp-progress-bar", template: `<!-- xp-progress-bar.component.html
     XP progress bar with optional level / XP label row.
-->

<div class="w-full">
  @if (showLabel()) {
    <div class="flex justify-between items-center mb-1">
      <span class="text-xs font-bold text-gray-700 dark:text-gray-300 transition-colors">
        Nivel {{ level() }}
      </span>
      <span class="text-xs font-semibold text-gray-500 dark:text-gray-400 transition-colors">
        {{ currentXP() }} / {{ maxXP() }} XP
      </span>
    </div>
  }
  <div [class]="'w-full bg-gray-100 dark:bg-[#2D2D4A] rounded-full overflow-hidden transition-colors ' + heightClass()">
    <div
      class="h-full bg-gradient-to-r from-orange-400 to-rose-500 rounded-full transition-all duration-1000 ease-out"
      [style.width.%]="percentage()">
    </div>
  </div>
</div>
` }]
  }], null, { currentXP: [{ type: Input, args: [{ isSignal: true, alias: "currentXP", required: true }] }], maxXP: [{ type: Input, args: [{ isSignal: true, alias: "maxXP", required: true }] }], level: [{ type: Input, args: [{ isSignal: true, alias: "level", required: true }] }], size: [{ type: Input, args: [{ isSignal: true, alias: "size", required: false }] }], showLabel: [{ type: Input, args: [{ isSignal: true, alias: "showLabel", required: false }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(XpProgressBarComponent, { className: "XpProgressBarComponent", filePath: "src/app/shared/ui/xp-progress-bar/xp-progress-bar.component.ts", lineNumber: 17 });
})();
...
function SidebarComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i-lucide", 8);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("img", ctx_r0.sunIcon);
  }
}
function SidebarComponent_Conditional_13_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("img", ctx_r0.moonIcon);
  }
}
function SidebarComponent_For_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 10);
    \u0275\u0275element(1, "i-lucide", 24);
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275fac = function SidebarComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SidebarComponent)(\u0275\u0275directiveInject(ThemeService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 33, vars: 7, consts: [[1, "hidden", "md:flex", "flex-col", "w-64", "h-screen", "bg-[#1A1A2E]", "text-white", "fixed", "left-0", "top-0", "z-50", "border-r", "border-gray-800", "shadow-2xl"], [1, "p-6", "flex", "items-center", "justify-between", "border-b", "border-gray-800/50"], [1, "flex", "items-center", "gap-3"], [1, "w-10", "h-10", "bg-gradient-to-br", "from-[#FF6B6B]", "to-[#FF8E8E]", "rounded-xl", "flex", "items-center", "justify-center", "shadow-lg", "shadow-rose-900/20"], [1, "text-xl"], [1, "text-xl", "font-black", "tracking-tight"], [1, "text-[10px]", "text-gray-400", "uppercase", "tracking-widest", "font-bold"], ["aria-label", "Toggle theme", 1, "p-2", "rounded-full", "bg-gray-800/50", "hover:bg-gray-700", "text-gray-400", "hover:text-white", "transition-colors", 3, "click"], [1, "w-4", "h-4", 3, "img"], [1, "flex-1", "py-6", "px-3", "space-y-1", "overflow-y-auto"], ["routerLinkActive", "active-nav", 1, "w-full", "flex", "items-center", "gap-3", "px-4", "py-3", "rounded-xl", "transition-all", "duration-200", "text-gray-400", "hover:bg-white/5", "hover:text-gray-200", "relative", "group", "nav-item", 3, "routerLink"], [1, "p-4", "bg-[#131322]", "border-t", "border-gray-800"], ["routerLink", "/perfil", 1, "block", "w-full", "bg-[#1A1A2E]", "rounded-2xl", "p-3", "border", "border-gray-700/50", "hover:border-gray-600", "transition-colors", "group", "text-left"], [1, "flex", "items-center", "gap-3", "mb-3"], [1, "relative"], [1, "w-10", "h-10", "rounded-full", "bg-gray-700", "overflow-hidden", "border-2", "border-gray-600", "group-hover:border-gray-500", "transition-colors"], ["src", "https://api.dicebear.com/7.x/avataaars/svg?seed=Felix", "alt", "User", 1, "w-full", "h-full", "object-cover"], [1, "absolute", "-bottom-1", "-right-1", "bg-[#1A1A2E]", "rounded-full", "p-0.5"], [1, "w-3.5", "h-3.5", "bg-green-500", "rounded-full", "border-2", "border-[#1A1A2E]"], [1, "flex-1", "min-w-0"], [1, "text-sm", "font-bold", "text-white", "truncate"], [1, "flex", "items-center", "text-xs", "text-orange-400", "font-semibold"], [1, "w-3", "h-3", "mr-1", "fill-current", 3, "img"], ["size", "sm", 3, "currentXP", "maxXP", "level", "showLabel"], [1, "w-5", "h-5", "flex-shrink-0", 3, "img"], [1, "font-semibold"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function SidebarComponent_Template_button_click_11_listener() {
        return ctx.themeService.toggleTheme();
      });
      \u0275\u0275conditionalCreate(12, SidebarComponent_Conditional_12_Template, 1, 1, "i-lucide", 8)(13, SidebarComponent_Conditional_13_Template, 1, 1, "i-lucide", 8);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(14, "nav", 9);
      \u0275\u0275repeaterCreate(15, SidebarComponent_For_16_Template, 4, 3, "a", 10, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "div", 11)(18, "a", 12)(19, "div", 13)(20, "div", 14)(21, "div", 15);
      \u0275\u0275element(22, "img", 16);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "div", 17);
      \u0275\u0275element(24, "div", 18);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(25, "div", 19)(26, "h4", 20);
      \u0275\u0275text(27, "Felix");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "div", 21);
      \u0275\u0275element(29, "i-lucide", 22);
      \u0275\u0275elementStart(30, "span");
      \u0275\u0275text(31);
      \u0275\u0275elementEnd()()()();
      \u0275\u0275element(32, "app-xp-progress-bar", 23);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(12);
      ...
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate1("", ctx.userStats.streak, " d\xEDas racha");
      \u0275\u0275advance();
      \u0275\u0275property("currentXP", ctx.userStats.xp)("maxXP", 3e3)("level", ctx.userStats.level)("showLabel", true);
    }
  }, dependencies: [LucideAngularModule, LucideAngularComponent, XpProgressBarComponent, RouterLink, RouterLinkActive], styles: ['\n\n.nav-item.active-nav[_ngcontent-%COMP%] {\n  background-color: rgba(255, 255, 255, 0.1);\n  color: white;\n  font-weight: 700;\n}\n.nav-item.active-nav[_ngcontent-%COMP%]   i-lucide[_ngcontent-%COMP%] {\n  color: #ff6b6b;\n}\n.nav-item.active-nav[_ngcontent-%COMP%]::before {\n  content: "";\n  position: absolute;\n  left: 0;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 3px;\n  height: 32px;\n  background: #ff6b6b;\n  border-radius: 0 4px 4px 0;\n}\n/*# sourceMappingURL=sidebar.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SidebarComponent, [{
    type: Component,
    args: [{ selector: "app-sidebar", standalone: true, imports: [LucideAngularModule, XpProgressBarComponent, RouterLink, RouterLinkActive], template: `<!-- shared/layout/sidebar/sidebar.component.html -->
<div class="hidden md:flex flex-col w-64 h-screen bg-[#1A1A2E] text-white fixed left-0 top-0 z-50 border-r border-gray-800 shadow-2xl">

  <!-- Logo -->
  <div class="p-6 flex items-center justify-between border-b border-gray-800/50">
    <div class="flex items-center gap-3">
      <div class="w-10 h-10 bg-gradient-to-br from-[#FF6B6B] to-[#FF8E8E] rounded-xl flex items-center justify-center shadow-lg shadow-rose-900/20">
        <span class="text-xl">\u26A1</span>
      </div>
      <div>
        <h1 class="text-xl font-black tracking-tight">SPORTMATE</h1>
        <p class="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Beta</p>
      </div>
    </div>
    <button
      (click)="themeService.toggleTheme()"
      class="p-2 rounded-full bg-gray-800/50 hover:bg-gray-700 text-gray-400 hover:text-white transition-colors"
      aria-label="Toggle theme">
      @if (themeService.theme() === 'dark') {
        <i-lucide [img]="sunIcon" class="w-4 h-4"></i-lucide>
      } @else {
        <i-lucide [img]="moonIcon" class="w-4 h-4"></i-lucide>
      }
    </button>
  </div>
  ...
  <nav class="flex-1 py-6 px-3 space-y-1 overflow-y-auto">
    @for (item of menuItems; track item.path) {
      <a [routerLink]="item.path" routerLinkActive="active-nav"
        class="w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-gray-400 hover:bg-white/5 hover:text-gray-200 relative group nav-item">
        <i-lucide [img]="item.icon" class="w-5 h-5 flex-shrink-0"></i-lucide>
  ...
  <!-- User Profile -->
  <div class="p-4 bg-[#131322] border-t border-gray-800">
    <a routerLink="/perfil"
      class="block w-full bg-[#1A1A2E] rounded-2xl p-3 border border-gray-700/50 hover:border-gray-600 transition-colors group text-left">
      <div class="flex items-center gap-3 mb-3">
        <div class="relative">
          <div class="w-10 h-10 rounded-full bg-gray-700 overflow-hidden border-2 border-gray-600 group-hover:border-gray-500 transition-colors">
            <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Felix" alt="User" class="w-full h-full object-cover" />
          </div>
          <div class="absolute -bottom-1 -right-1 bg-[#1A1A2E] rounded-full p-0.5">
            <div class="w-3.5 h-3.5 bg-green-500 rounded-full border-2 border-[#1A1A2E]"></div>
          </div>
        </div>
        <div class="flex-1 min-w-0">
          <h4 class="text-sm font-bold text-white truncate">Felix</h4>
          <div class="flex items-center text-xs text-orange-400 font-semibold">
            <i-lucide [img]="flameIcon" class="w-3 h-3 mr-1 fill-current"></i-lucide>
            <span>{{ userStats.streak }} d\xEDas racha</span>
          </div>
        </div>
      </div>
      <app-xp-progress-bar
...
`, styles: ['/* src/app/shared/layout/sidebar/sidebar.component.scss */\n.nav-item.active-nav {\n  background-color: rgba(255, 255, 255, 0.1);\n  color: white;\n  font-weight: 700;\n}\n.nav-item.active-nav i-lucide {\n  color: #ff6b6b;\n}\n.nav-item.active-nav::before {\n  content: "";\n  position: absolute;\n  left: 0;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 3px;\n  height: 32px;\n  background: #ff6b6b;\n  border-radius: 0 4px 4px 0;\n}\n/*# sourceMappingURL=sidebar.component.css.map */\n'] }]
  }], () => [{ type: ThemeService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "src/app/shared/layout/sidebar/sidebar.component.ts", lineNumber: 22 });
})();

// src/app/shared/layout/bottom-nav/bottom-nav.component.ts
var _forTrack02 = ($index, $item) => $item.path;
function BottomNavComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i-lucide", 4);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("img", ctx_r0.sunIcon);
...
function BottomNavComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i-lucide", 4);
  }
  if (rf & 2) {
...
function BottomNavComponent_For_6_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "div", 7);
  }
}
function BottomNavComponent_For_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 6, 0);
    \u0275\u0275conditionalCreate(2, BottomNavComponent_For_6_Conditional_2_Template, 1, 0, "div", 7);
    \u0275\u0275element(3, "i-lucide", 8);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classMap(rla_r3.isActive ? "text-[#FF6B6B]" : "text-gray-400 dark:text-gray-500");
    \u0275\u0275property("routerLink", tab_r2.path);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(rla_r3.isActive ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("img", tab_r2.icon);
    \u0275\u0275advance(2);
...
var BottomNavComponent = class _BottomNavComponent {
  ...
  static \u0275fac = function BottomNavComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _BottomNavComponent)(\u0275\u0275directiveInject(ThemeService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BottomNavComponent, selectors: [["app-bottom-nav"]], decls: 7, vars: 1, consts: [["rla", "routerLinkActive"], [1, "fixed", "bottom-0", "left-0", "right-0", "bg-white", "dark:bg-[#1A1A2E]", "border-t", "border-gray-100", "dark:border-[#2D2D4A]", "pt-2", "pb-safe", "px-2", "z-50", "shadow-[0_-4px_20px_rgba(0,0,0,0.04)]", "dark:shadow-[0_-4px_20px_rgba(0,0,0,0.2)]", "transition-colors", "duration-300"], [1, "flex", "justify-around", "items-end", "pb-2", "relative"], ["aria-label", "Toggle theme", 1, "absolute", "-top-12", "right-4", "p-2", "rounded-full", "bg-white", "dark:bg-[#22223A]", "shadow-md", "border", "border-gray-100", "dark:border-[#2D2D4A]", "text-gray-400", "dark:text-gray-300", "transition-all", "active:scale-90", 3, "click"], [1, "w-5", "h-5", 3, "img"], ["routerLinkActive", "", 1, "relative", "flex", "flex-col", "items-center", "justify-center", "w-14", "py-1", "transition-colors", 3, "routerLink", "class"], ["routerLinkActive", "", 1, "relative", "flex", "flex-col", "items-center", "justify-center", "w-14", "py-1", "transition-colors", 3, "routerLink"], [1, "absolute", "-top-2", "w-8", "h-1", "bg-gradient-to-r", "from-[#FF6B6B]", "to-[#FF8E8E]", "rounded-full"], [1, "w-6", "h-6", 3, "img"], [1, "text-[10px]", "font-bold", "mt-1"]], template: function BottomNavComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "button", 3);
      \u0275\u0275listener("click", function BottomNavComponent_Template_button_click_2_listener() {
        return ctx.themeService.toggleTheme();
      });
      \u0275\u0275conditionalCreate(3, BottomNavComponent_Conditional_3_Template, 1, 1, "i-lucide", 4)(4, BottomNavComponent_Conditional_4_Template, 1, 1, "i-lucide", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(5, BottomNavComponent_For_6_Template, 6, 6, "a", 5, _forTrack02);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.themeService.theme() === "dark" ? 3 : 4);
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.tabs);
    }
  }, dependencies: [LucideAngularModule, LucideAngularComponent, RouterLink, RouterLinkActive], styles: ["\n\n/*# sourceMappingURL=bottom-nav.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BottomNavComponent, [{
    type: Component,
    args: [{ selector: "app-bottom-nav", standalone: true, imports: [LucideAngularModule, RouterLink, RouterLinkActive], template: `<!-- shared/layout/bottom-nav/bottom-nav.component.html -->
<div class="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1A1A2E] border-t border-gray-100 dark:border-[#2D2D4A] pt-2 pb-safe px-2 z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_-4px_20px_rgba(0,0,0,0.2)] transition-colors duration-300">
  <div class="flex justify-around items-end pb-2 relative">

    <!-- Theme toggle -->
    <button
      (click)="themeService.toggleTheme()"
      class="absolute -top-12 right-4 p-2 rounded-full bg-white dark:bg-[#22223A] shadow-md border border-gray-100 dark:border-[#2D2D4A] text-gray-400 dark:text-gray-300 transition-all active:scale-90"
      aria-label="Toggle theme">
      @if (themeService.theme() === 'dark') {
        <i-lucide [img]="sunIcon" class="w-5 h-5"></i-lucide>
      } @else {
        <i-lucide [img]="moonIcon" class="w-5 h-5"></i-lucide>
      }
    </button>

    @for (tab of tabs; track tab.path) {
      <a [routerLink]="tab.path" routerLinkActive #rla="routerLinkActive"
        class="relative flex flex-col items-center justify-center w-14 py-1 transition-colors"
        [class]="rla.isActive ? 'text-[#FF6B6B]' : 'text-gray-400 dark:text-gray-500'">
        @if (rla.isActive) {
          <div class="absolute -top-2 w-8 h-1 bg-gradient-to-r from-[#FF6B6B] to-[#FF8E8E] rounded-full"></div>
        }
        <i-lucide [img]="tab.icon" class="w-6 h-6"></i-lucide>
        <span class="text-[10px] font-bold mt-1">{{ tab.label }}</span>
      </a>
    }
  </div>
</div>
`, styles: ["/* src/app/shared/layout/bottom-nav/bottom-nav.component.scss */\n/*# sourceMappingURL=bottom-nav.component.css.map */\n"] }]
  }], () => [{ type: ThemeService }], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BottomNavComponent, { className: "BottomNavComponent", filePath: "src/app/shared/layout/bottom-nav/bottom-nav.component.ts", lineNumber: 20 });
})();
...
var App = class _App {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 6, vars: 0, consts: [[1, "min-h-screen", "bg-[#F8FAFC]", "dark:bg-[#0F0F1A]", "flex", "text-[#1E293B]", "dark:text-[#F0F0F5]", "transition-colors", "duration-300"], [1, "flex-1", "md:ml-64", "w-full", "min-h-screen", "overflow-x-hidden"], [1, "md:hidden"]], template: function App_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [RouterOutlet, SidebarComponent, BottomNavComponent], encapsulation: 2 });
};
(() => {
